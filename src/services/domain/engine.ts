...
import { SITUACOES_BLOQUEADAS, SITUACOES_PRECO, type SituacaoPreco } from './servicos';
import { MODELO_CONTRATO, MODELO_CONTRATO_VERSAO, pendenciasDoModelo } from './modelosDocumento';
