...
export const COLLECTIONS = ['clientes','tarefas','processos','leads','propostas','faturas','despesas','servicos','documentos','licencas','equipe','sistemas','integracoes','metas','cargos','avaliacoes','conversas','irpf','atividades','configuracoes'] as const;
